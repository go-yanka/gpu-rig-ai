...
class CBICScraper(BaseScraper):
    ...
    def __init__(self, root_dir: str):
        ...
        self.token_bucket = ThreadSafeTokenBucket(rps=3.0)
    ...
    def stage_download(self, scope=None, languages=("en", "hi"),
        ...
        self.writer_thread = threading.Thread(target=manifest_writer, daemon=True)
            ...
            try:
                ...
                for lang in languages:
                    ...
                    try:
                        ...
                        last_err = f"{lang}: {e}"
                        log.warning(f"[{cat}/{sub}/{did}] {lang} FAIL: {e}")
